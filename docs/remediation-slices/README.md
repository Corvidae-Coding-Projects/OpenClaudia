...
There are **106 slices** covering all **143 findings exactly once as a primary responsibility** and every design workstream W0–W28. A slice may support adjacent findings, but primary ownership does not overlap.
...
| [S-106 — Add host-reviewed technical-memory authority and portable export](./106-host-reviewed-memory-export.md) | Medium | Design requirement from W5 | W2, W5, W15 | S-017, S-054, S-056 |
