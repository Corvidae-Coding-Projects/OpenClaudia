...
mod tests {
    ...
    fn grounding_message_states_summary_and_memory_are_not_evidence() {
        ...
        assert!(rendered.contains("When no verifier observation is listed"));
        assert!(rendered.contains("label unverified correctness as unresolved"));
